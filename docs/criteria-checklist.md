...
| --- | --- |
| Define prohibited categories with rationale | `docs/taxonomy.md`, `src/img_censor/policy.py` category metadata |
...
| Regulator explanation | audit fields: policy version, detector, category, score, rationale, category evidence |
